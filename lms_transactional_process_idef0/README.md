...
![Финальная версия Диаграмма A-0](artifacts/3version_A-0.svg)

Помимо внесённых изменений с точки зрения формулировки в качестве выхода установлен поток "Рейтинг студентов". Несмотря на то что он составляется из баллов и фактически является производной вердиктов, он учтён, потому именно на основе рейтинга впоследствии студентам выставляется оценка по дисциплине, преподаваемой на платформе.

![Финальная версия Диаграмма A0](artifacts/3version_A0.svg)

На диаграмме верхнего уровня можно заметить 2 роли, являющиеся механизмами процесса. С точки зрения платформы не так важны ассистенты (которые фактически являются преподавателем с урезанными правами и были добавлены на прошлых версиях), как администраторы. Они занимаются предварительной подготовкой платформы и задач и распределением преподавателей по курсам - в соответствии с структурными требованиями. На диаграмме A0 их работе выделен блок "Подготовить банк задач и класс".

![Финальная версия Диаграмма A1](artifacts/3version_A1.svg)

Затем преподаватель, получивший класс и доступ к банку задач благодаря работе администратора, занимается предварительной настройкой класса (в том числе добавлением и редактированием задач из общего банка) и управлением студентами.

![Финальная версия Диаграмма A0](artifacts/3version_A2.svg)

И следом студенты, получившие доступ к задачам класса, занимаются их решением и решения оцениваются. Данному процессу выделен блок А3 "Осуществить учебную деятельность".

![Финальная версия Диаграмма A0](artifacts/3version_A3.svg)

Дополнительно описан порядок оценки решения, так как он является ключевым из-за фигурирования в нём вердиктов - основных транзакционных единиц системы.

![Финальная версия Диаграмма A33](artifacts/3version_A33.svg)
