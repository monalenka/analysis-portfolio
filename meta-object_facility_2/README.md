...
## Содержание
1. История появления и проблематика
2. Пакетное представление MOF2
3. Целесообразность разделения на EMOF и CMOF
4. Метаклассы CMOF
5. Проблема повторного использования метаклассов
